...
jQuery(function() {
    ...
    jQuery('.nav-tabs > li a').on('click',function(){
      ...
      if(jQuery(this).hasClass('li1')){
        jQuery('.span-change').text('What’s in the set')
      }
      if(jQuery(this).hasClass('li2')){
        jQuery('.span-change').text('Specifications')
      }
      if(jQuery(this).hasClass('li3')){
        jQuery('.span-change').text('Additional information')
      }
      if(jQuery(this).hasClass('li4')){
        jQuery('.span-change').text('Features')
      }
      if(jQuery(this).hasClass('li5')){
        jQuery('.span-change').text('Downloads')
      }
      if(jQuery(this).hasClass('li6')){
        jQuery('.span-change').text('Compatible accessories')
      }
    });
